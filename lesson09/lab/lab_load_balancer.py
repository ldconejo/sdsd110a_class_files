...
class RoundRobinBalancer:
    ...
    def select_server(self) -> Optional[Server]:
        """TODO: Select next server in round-robin order"""
...
class LeastConnectionsBalancer:
    ...
    def select_server(self) -> Optional[Server]:
        """TODO: Select server with fewest active connections"""
    ...
    def show_distribution(self, algorithm_name: str):
        ...
        for server in self.servers:
            if total_requests > 0:
                ...
                print(f"❌ {server.name:12}: 0 requests")
...
def main():
    ...
    print("Complete the TODO sections in the algorithms above, then run this simulation.")
