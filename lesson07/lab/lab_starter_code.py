...
class ConnectionPool:
    ...
    def get_connection(self):
        ...
        # 1. If there's an available connection, return it
        # 2. If no available connections and under limit, create new one
        # 3. If at limit and no available connections, wait or return None
        
        # HINT: Check if self.available_connections has any connections
        # HINT: If empty, check if self.total_connections < self.max_connections
    ...
    def return_connection(self, connection):
        ...
        # TODO: Implement this method
        # 1. Add the connection back to available_connections
        # 2. Don't add it if it's already in the list
        
        # HINT: Use self.available_connections.append(connection)
