...
def test_counter(counter, num_threads=4, operations_per_thread=1000):
    """
    Test a counter with multiple threads.
    ...
    # Calculate what the final value should be
    expected_increments = int(operations_per_thread * 0.7) * num_threads
    expected_decrements = int(operations_per_thread * 0.3) * num_threads
    expected_value = expected_increments - expected_decrements
